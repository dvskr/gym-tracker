...
async function main() {
  ...
  // #region agent log
  debugLog('copy-duplicates.ts:main:start', 'Starting GIF copy process', {}, 'H1');
  // #endregion
  ...
  // #region agent log
  debugLog('copy-duplicates.ts:exercises:fetched', 'Exercises fetched', {
  ...
  // #region agent log
  debugLog('copy-duplicates.ts:copy:complete', 'Copy process complete', {
    copied,
    failed,
    skipped
  }, 'H2');
  ...
  if (copied > 0) {
    console.log(`\n  Uploading ${copied} new GIFs and thumbnails to Supabase...\n`);
    ...
    // #region agent log
    debugLog('copy-duplicates.ts:upload:complete', 'Upload complete', {
      uploadedGifs,
      uploadedThumbs
    }, 'H3');
    // #endregion
    ...
    // #region agent log
    debugLog('copy-duplicates.ts:update:complete', 'Database update complete', {
      updated
    }, 'H4');
    // #endregion
  }
  ...
  // #region agent log
  debugLog('copy-duplicates.ts:main:complete', 'Process complete', {
    copied,
    skipped,
    failed,
