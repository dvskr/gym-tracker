  ...
  for (const serverItem of serverItems) {
    ...
    if (!localItem) {
      ...
      if (conflictResolver.hasConflict(localItem, serverItem)) {
        ...
        console.log(`⚠️ Conflict detected for ${tableName}/${serverItem.id}`);
...
export async function mergeWorkouts(serverWorkouts: any[]): Promise<void> {
  console.log(`🔄 Merging ${serverWorkouts.length} workout(s)...`);
  ...
  try {
    ...
    console.log(`✅ Merged workouts: ${merged.length} total`);
  } catch (error) {
...
export async function mergeTemplates(serverTemplates: any[]): Promise<void> {
  console.log(`🔄 Merging ${serverTemplates.length} template(s)...`);
  ...
  try {
    ...
    console.log(`✅ Merged templates: ${merged.length} total`);
  } catch (error) {
...
export async function mergeWeightLog(serverWeightLog: any[]): Promise<void> {
  console.log(`🔄 Merging ${serverWeightLog.length} weight log(s)...`);
  ...
  try {
    ...
    console.log(`✅ Merged weight log: ${merged.length} total`);
  } catch (error) {
    console.error('Error merging weight log:', error);
    throw error;
  }
}
...
export async function mergeMeasurements(serverMeasurements: any[]): Promise<void> {
  console.log(`🔄 Merging ${serverMeasurements.length} measurement(s)...`);
  ...
  try {
    ...
    console.log(`✅ Merged measurements: ${merged.length} total`);
  } catch (error) {
    console.error('Error merging measurements:', error);
    throw error;
  }
}
...
export async function mergePersonalRecords(serverRecords: any[]): Promise<void> {
  console.log(`🔄 Merging ${serverRecords.length} personal record(s)...`);
  ...
  try {
    ...
    console.log(`✅ Merged personal records: ${merged.length} total`);
  } catch (error) {
    console.error('Error merging personal records:', error);
    throw error;
  }
}
...
export async function mergeExercises(serverExercises: any[]): Promise<void> {
  console.log(`🔄 Caching ${serverExercises.length} exercise(s)...`);

  try {
    await localDB.cacheExercises(serverExercises);
    console.log(`✅ Cached ${serverExercises.length} exercises`);
  } catch (error) {
