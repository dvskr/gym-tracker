...
export const example1_basicCheck = () => {
 logger.log('\nx` Example 1: Basic Specificity Check');
  ...
  const specificResponse = 
    "Your bench press at 1858 last week was solid! Since you hit all reps, " +
 ...
 logger.log('\nx Example 4: AI Service Integration');
  ...
  const mockAIService = {
    responses: [
      ...
      "Your bench press at 1858 last week shows you're ready for 190 lbs next session.",
    ],
    currentIndex: 0,
...
export const example5_scoringBreakdown = () => {
 logger.log('\nx} Example 5: Scoring Breakdown');
  ...
  const testCases = [
    ...
    {
      name: 'Full context',
      text: 'Your bench press at 1858 last week was great.',
      expectedScore: 80,
    },
  ];
...
export const example7_thresholdTesting = () => {
 logger.log('\nx}a Example 7: Testing Different Thresholds');
...
export const example8_completeIntegration = async () => {
 ...
 logger.log('\nStep 3: Get AI response...');
  const aiResponse = 
    "Your bench press at 1858 yesterday was strong! You're ready to bump up to " +
